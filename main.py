...
def add_item_shopping_list():
    ...
    speaker.say("Quel article voulez-vous ajouter dans votre liste d'achat?")
    speaker.runAndWait()
...
def create_complaint():
    ...
    speaker.say("s'il vous plait exprimer votre réclamation")
    speaker.runAndWait()
    ...
    while not done:
            ...
            with speech_recognition.Microphone() as mic:
                ...
                speaker.say("quel est  votre identifiant?")
                speaker.runAndWait()
            ...
            with open(f"{filename}_réclamation.txt", 'w') as f:
                f.write(note)
                done = True
                speaker.say("Votre réclamation a été envoyée avec succès")
                speaker.runAndWait()
...
def order_status():
    global recognizer
    speaker.say("quel est votre numéro de commande")
    speaker.runAndWait()
    done=False
    ...
    while not done:
        # try:
            ...
            with speech_recognition.Microphone() as mic:
                ...
                number = recognizer.recognize_google(audio, language="fr-FR")
                number = number.lower()
...
def delivered():
    speaker.say("votre commande est déjà livrée")
    speaker.runAndWait()
